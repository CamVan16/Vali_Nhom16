  ...
  <>
    ...
    <Footer className="footer-container">
      <div className="footer-section">
        <h4 className="footer-title" style={{
          fontFamily: "'Pacifico', cursive",
        fontSize: "20px"}}>LUGKY</h4>
      ...
      <div className="footer-section ">
        ...
        <div className="social-icons">
          <a href="#" target="_blank" rel="noopener noreferrer" className="footer-link">
            <FacebookFilled style={{ color: '#fff', fontSize: "24px" }} />
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer">
            <TwitterCircleFilled style={{ color: '#fff', fontSize: "24px" }} />
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer">
            <YoutubeFilled style={{ color: '#fff', fontSize: "24px" }} />
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer">
